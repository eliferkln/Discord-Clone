...
function ActionButtons({
  ...
  return (
    <div
      className="relative text-gray-300 hover:text-white hover:cursor-pointer group mx-3"
      onClick={onClick}
    >
      {children}
      <span className="absolute top-10 bg-black min-w-fit p-2 text-xs font-bold scale-0 group-hover:scale-100">
        {tooltip}
      </span>
    </div>
  );
